...
!((t, e) => {
  ...
  class z extends F {
    ...
    static getInstance(t) {
      return H.get(r(t), z.DATA_KEY);
    }
    static getOrCreateInstance(t, e = {}) {
      return z.getInstance(t) || new z(t, "object" == typeof e ? e : null);
    }
    static get VERSION() {
      return "5.2.3";
    }
  ...
  var gt = "top",
    ...
    Ct = "popper",
    Ot = "reference",
    xt = yt.reduce((t, e) => t.concat([e + "-" + wt, e + "-" + At]), []),
    kt = [].concat(yt, [vt]).reduce((t, e) => t.concat([e, e + "-" + wt, e + "-" + At]), []),
    Lt = "beforeRead",
    Dt = "read",
    St = "afterRead",
    It = "beforeMain",
      ...
      return (
        ...
        () => {
          Object.keys(e.elements).forEach((t) => {
            var n = e.elements[t],
              s = e.attributes[t] || {},
              o = Object.keys(Object.hasOwn(e.styles, t) ? e.styles[t] : i[t]).reduce((t, e) => ((t[e] = ""), t), {});
            zt(n) &&
              Wt(n) &&
  ...
  function be(t) {
    return t.replace(/left|right|bottom|top/g, (t) => _e[t]);
  }
  var ve = { start: "end", end: "start" };
  function ye(t) {
    return t.replace(/start|end/g, (t) => ve[t]);
  }
  function we(t) {
    var e = Bt(t);
        ...
        var s =
            "clippingParents" === e
              ? ((t) => {
                  ...
                  return Ft(i) ? e.filter((t) => Ft(t) && Zt(t, i) && "body" !== Wt(t)) : [];
                })(t)
              : [].concat(e),
          o = [].concat(s, [i]),
          r = o[0],
  ...
  function De(t, e) {
    ...
    var i = e,
      ...
      c = void 0 === l ? kt : l,
      h = de(n),
      d = h ? (a ? xt : xt.filter((t) => de(t) === h)) : yt,
      u = d.filter((t) => c.indexOf(t) >= 0);
    0 === u.length && (u = d);
    var f = u.reduce(
      (e, i) => ((e[i] = Le(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[Vt(i)]), e),
      {},
    );
    ...
    fn: (t) => {
      ...
      if (!e.modifiersData[n]._skip) {
        for (
          ...
          var N = be(I),
            P = [];
          if ((o && P.push(S[x] <= 0), a && P.push(S[I] <= 0, S[N] <= 0), P.every((t) => t))) {
            (T = O), (E = !1);
            break;
          }
          A.set(O, P);
  ...
  function Ne(t) {
    return [gt, _t, mt, bt].some((e) => t[e] >= 0);
  }
  const Pe = {
      name: "hide",
      enabled: !0,
        ...
        h = {
          ...
          setOptions: (i) => {
            ...
            var r,
              ...
              u = ((t) => {
                var e = We(t);
                return $t.reduce((t, i) => t.concat(e.filter((t) => t.phase === i)), []);
              })(
  ...
  class hi extends z {
    ...
    static dataApiKeydownHandler(t) {
      ...
      if (e && !i) return;
      t.preventDefault();
      const s = hi.matches(Ze)
          ? hi
          : Q.prev(hi, Ze)[0] || Q.next(hi, Ze)[0] || Q.findOne(Ze, t.delegateTarget.parentNode),
