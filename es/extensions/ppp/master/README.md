...
- Remueve los códigos `+partyRole.csv` no usados:
  - consortiaMember
  - grantor
  - notary
  - otherWitness
...
- Remueve los códigos 'qualifiedBidder' y 'disqualifiedBidder' de `+partyRole.csv` (fuerons movidos a la extensión de [qualification](https://github.com/open-contracting-extensions/ocds_qualification_extension)).
